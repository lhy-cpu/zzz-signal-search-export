import { isWeapon, isCharacter, isBanbo} from './utils'
...
const order = ['2001', '3001', '1001', '5001']
...
const gachaDetail = (data) => {
  ...
  for (let key of order) {
    ...
    let detail = {
      ...
      count3w: 0, count4w: 0, count5w: 0, count4c: 0, count5c: 0, count4b: 0, count5b: 0,
      weapon3: new Map(), weapon4: new Map(), weapon5: new Map(),
      char4: new Map(), char5: new Map(),
      banbo4: new Map(), banbo5: new Map(),
      date: [],
    ...
    value.forEach((item, index) => {
      ...
      if (rank === '2') {
        ...
        } else if (isBanbo(type)) {
          detail.count4b++
          itemCount(detail.banbo4, name)
        }
      } else if (rank === '4') {
