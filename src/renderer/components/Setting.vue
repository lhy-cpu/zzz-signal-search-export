<template>
  <div class="bg-white py-4 px-6 w-screen h-screen fixed inset-0 overflow-y-auto">
    ...
    <p class="text-gray-600 text-xs mt-1">Github: <a @click="openGithub" class="cursor-pointer text-blue-400">https://github.com/lhy-cpu/zzz-signal-search-export</a></p>
    <p class="text-gray-600 text-xs mt-1">Base on: <a @click="openGithub_b" class="cursor-pointer text-blue-400">https://github.com/biuuu/star-rail-warp-export</a></p>
...
const openGithub = () => shell.openExternal('https://github.com/lhy-cpu/zzz-signal-search-export')
const openGithub_b = () => shell.openExternal('https://github.com/biuuu/star-rail-warp-export')
